...
<form action="/package/{{$package->id}}" enctype="multipart/form-data" method="POST">
    ...
    <input placeholder="days/nights"  class="form-control" type="text" name="days/nights" value="{{$package->days/nights}}"  id="days/nights">
    @error('days/nights')
        <small style="color:red !important" id="" class="form-text text-muted">{{$message}}</small>
        @enderror
    </div>
    ...
    <input placeholder="ratings"  class="form-control" type="text" name="ratings" value="{{$package->ratings}}"  id="ratings">
    @error('ratings')
        <small style="color:red !important" id="" class="form-text text-muted">{{$message}}</small>
        @enderror
    </div>
